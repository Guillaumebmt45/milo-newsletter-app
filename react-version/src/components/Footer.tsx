      ...
      <div className="container mx-auto max-w-container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <MiloLogo className="h-8 w-auto" />
            </div>
            <p className="text-text-secondary mb-6">
              Curated insights for professionals who want to stay ahead of the curve.
            </p>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  href="#benefits" 
                  className="text-text-secondary hover:text-accent transition-colors"
                  onClick={() => handleFooterLinkClick('benefits')}
                >
                  Benefits
                </a>
              </li>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  href="#" 
                  className="text-text-secondary hover:text-accent transition-colors"
                  onClick={() => handleFooterLinkClick('gdpr')}
                >
                  GDPR Compliance
                </a>
              </li>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-text-secondary text-sm mb-4 md:mb-0">
            &copy; {currentYear} Milo. All rights reserved.
          </p>
          <div className="flex items-center">
            <a 
              href="#" 
              className="text-text-secondary hover:text-accent transition-colors text-sm mx-2"
            ...
            <a 
              href="#" 
              className="text-text-secondary hover:text-accent transition-colors text-sm mx-2"
              onClick={() => handleFooterLinkClick('sitemap')}
            >
              Sitemap
            </a>
          </div>
